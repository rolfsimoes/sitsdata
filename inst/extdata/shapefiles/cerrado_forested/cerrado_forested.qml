...
<qgis simplifyDrawingTol="1" maxScale="0" readOnly="0" minScale="1e+8" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" version="3.0.0-Girona" labelsEnabled="0">
    ...
    <symbols>
      <symbol clip_to_extent="1" name="0" alpha="1" type="marker">
        <layer class="EllipseMarker" pass="0" enabled="1" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="140,233,143,255"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory scaleBasedVisibility="0" penColor="#000000" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" barWidth="5" opacity="1" enabled="0" width="15" maxScaleDenominator="1e+8" diagramOrientation="Up" sizeType="MM" backgroundColor="#ffffff" height="15" minimumSize="0" labelPlacementMethod="XHeight" scaleDependency="Area" lineSizeScale="3x:0,0,0,0,0,0" backgroundAlpha="255" penWidth="0" lineSizeType="MM" rotationOffset="270" penAlpha="255">
